...
public class OneDriver extends CommandOpMode {
    ...
    public void initialize() {
        ...
        gamepad.getGamepadButton(GamepadKeys.Button.Y).whenPressed(new InstantCommand(basket::toggle, basket));
        gamepad.getGamepadButton(GamepadKeys.Button.A).whenHeld(new RunIntakeCommand(intake, true));
