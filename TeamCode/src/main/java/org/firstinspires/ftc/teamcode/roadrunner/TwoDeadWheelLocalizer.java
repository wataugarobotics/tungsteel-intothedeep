...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 834.4012510080255; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1875.9897515606651; // x position of the perpendicular encoder (in tick units)
    }
